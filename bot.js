...
// 💾 ENHANCED FIRESTORE STORAGE MANAGER
    ...
    async init() {
        try {
            ...
            if (db) {
                ...
                console.log('❌ Firestore Storage failed to initialize');
            }
        } catch (error) {
...
// 💾 ENHANCED DATABASE MANAGER - FIRESTORE ONLY
...
bot.start(async (ctx) => {
    try {
        ...
        // التحقق إذا كان المستخدم مسجل مسبقاً من Firestore
...
bot.launch().then(() => {
    ...
    console.log('💾 Persistent Data Storage in Firestore: ENABLED');
